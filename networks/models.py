...
class MlpLSTM(nn.Module):
    ...
    @jit.ignore
    def get_dist_info_forward(
        self, probs: Tensor, behav_acts: Tensor
    ...
    @jit.export
    def act(
        self, obs: Tensor, lstm_hxs: Tuple[Tensor, Tensor]
    ...
    @jit.export
    def forward(
        self, obs: Tensor, lstm_hxs: Tuple[Tensor, Tensor], behaviour_acts: Tensor
        ...
        dist_logits, dist_log_prob, dist_entropy = self.get_dist_info_forward(
            probs, behav_acts
        )
